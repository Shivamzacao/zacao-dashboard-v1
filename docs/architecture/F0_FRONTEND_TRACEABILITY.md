...
| Operations: shipped/delivered                         | `operations.shipped_delivered` (DEC-019)                                             | KPI/list                 | Operations      | REBUILD_TO_MATCH |
| Operations: fulfillment summary                       | `operations.fulfillment_summary` (BRR)                                               | Chart/list               | Operations      | CONDITIONAL      |
| Operations: fulfillment trend                         | `operations.fulfillment_trend` (DEC-019)                                             | Trend chart              | Operations      | REBUILD_TO_MATCH |
| Operations: observed units sold                       | `products.units_sold`, `products.units_velocity` (DEC-019)                            | Chart/table              | Operations      | REBUILD_TO_MATCH |
