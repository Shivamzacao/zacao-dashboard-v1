...
| Supabase, database schemas, migrations, Drizzle, RLS | Not present | **Retire / do not import** | Active V1 has no primary database. Re-entry requires a documented trigger and approved architecture revision. |
