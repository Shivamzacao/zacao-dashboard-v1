...
const SAMPLE_ROWS = {
  ...
  Sales_Forecast: [
    {
      record_id: "FCST-2026-W31-SKU01",
      forecast_version: "2026-08 v1",
      week_start: "2026-07-27",
      sku: "SKU-01",
      channel: "DTC (Shopify)",
      forecast_units: 420,
      forecast_revenue_usd: 5_040.0,
      status: "approved",
    },
    {
      record_id: "FCST-2026-W31-SKU02",
      forecast_version: "2026-08 v1",
      week_start: "2026-07-27",
      sku: "SKU-02",
      channel: "DTC (Shopify)",
      forecast_units: 260,
      forecast_revenue_usd: 3_120.0,
      status: "approved",
    },
  ],
  Metric_Targets: [
    {
      record_id: "MT-2026-07-REVENUE",
      metric_key: "commerce.net_sales",
      period_start: "2026-07-01",
      period_end: "2026-07-31",
      target_value: 15_000.0,
      unit: "usd",
      scope_type: "company",
      status: "active",
    },
    {
      record_id: "MT-2026-07-REORDER-SKU01",
