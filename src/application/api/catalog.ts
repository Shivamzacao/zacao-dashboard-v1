...
export const drilldownCatalog = Object.freeze([
  ...
  definition({
    ...
    fields: ["channel", "followers", "growthRateBasisPoints", "revenueMinorUnits", "audienceReach"],
    sortFields: ["channel", "followers", "growthRateBasisPoints", "revenueMinorUnits"],
    exportable: true,
  }),
  definition({
    ...
    fields: ["ambassador", "code", "clicks", "orders", "revenueMinorUnits", "commissionMinorUnits"],
    sortFields: ["ambassador", "clicks", "orders", "revenueMinorUnits"],
    exportable: true,
  }),
  definition({
    ...
    fields: ["partner", "category", "reach", "status", "launchDate"],
    sortFields: ["partner", "category", "reach", "status", "launchDate"],
    exportable: true,
  }),
  definition({
